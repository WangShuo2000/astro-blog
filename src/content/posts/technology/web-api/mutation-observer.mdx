...
<Image src={style} width={'50%'} height={100} alt="style" quality="high" />
...
<Image src={mutation} width={'50%'} height={230} alt="mutation" quality="high" />
...
<div>
  <Image src={changeColor} width={'50%'} height={100} alt="result" quality="high" />
</div>
控制台打印
<div>
  <Image src={attributes} width={'50%'} height={40} alt="console" quality="high" />
</div>
...
<div>
  <Image src={addChild} width={'50%'} height={100} alt="result" quality="high" />
</div>
控制台打印
<div>
  <Image src={subtree} width={'50%'} height={30} alt="console" quality="high" />
</div>
